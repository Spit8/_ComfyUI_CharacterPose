...
BONE_OFFSETS: dict[str, tuple[str | None, np.ndarray]] = {
    ...
    "r_elbow": ("r_shoulder", np.array([0.28, 0.0, 0.0])),
    "r_wrist": ("r_elbow", np.array([0.26, 0.0, 0.0])),
    "l_shoulder": ("chest", np.array([-0.18, 0.08, 0.0])),
    "l_elbow": ("l_shoulder", np.array([-0.28, 0.0, 0.0])),
    "l_wrist": ("l_elbow", np.array([-0.26, 0.0, 0.0])),
